<div class="wsus__user_list">
    <div class="wsus__user_list_header">
        <h3>
            <span><img src="{{ asset('chat/images/chat_list_icon.png') }}" alt="Chat" class="img-fluid"></span>
            MESSAGES
        </h3>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <form action="#">
                            ...
                            <div class="file">
                                <img src="{{ asset('chat/images/upload_img.jpg') }}" alt="Upload" class="img-fluid">
        ...
        <div class="user_search_result">
            <div class="wsus__user_list_area_height">
                <div class="wsus__user_list_item">
                    <div class="img">
                        <img src="{{ asset('chat/images/author_img_1.jpg') }}" alt="User" class="img-fluid">
