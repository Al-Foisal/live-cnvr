<div class="wsus__chat_area">
    ...
    <div class="wsus__chat_area_header">
        <div class="header_left">
            ...
            <img src="{{ asset('chat/images/author_img_2.jpg') }}" alt="User" class="img-fluid">
        ...
        <div class="wsus__single_chat_area">
            <div class="wsus__single_chat">
                ...
                <a class="venobox" data-gall="gallery01" href="images/chat_img.png')}}">
                    <img src="{{ asset('chat/images/chat_img.png') }}" alt="gallery1" class="img-fluid w-100">
                </a>
                <span class="time"> 5h ago</span>
                <a class="action" href="#"><i class="fas fa-trash"></i></a>
            </div>
    ...
    <div class="wsus__chat_area_footer">
        <div class="footer_message">
            <!-- <div class="img">
                        <img src="{{ asset('chat/images/chat_img.png') }}" alt="User" class="img-fluid">
